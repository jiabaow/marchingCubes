...
func convertTo3DArray(voxelArray: MDLVoxelArray) -> [[[Int]]] {
    ...
    let sizeX = Int((extent.maxBounds.x - extent.minBounds.x) * 2)
    let sizeY = Int((extent.maxBounds.y - extent.minBounds.y) * 2)
    let sizeZ = Int((extent.maxBounds.z - extent.minBounds.z) * 2)
