...
func convertTo3DArray(voxelArray: MDLVoxelArray) -> [[[Int]]] {
    ...
    let sizeX = Int(extent.maxBounds.x - extent.minBounds.x)
    let sizeY = Int(extent.maxBounds.y - extent.minBounds.y)
    let sizeZ = Int(extent.maxBounds.z - extent.minBounds.z)
